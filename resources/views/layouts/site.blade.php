...
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="csrf-token" content="{{ csrf_token() }}"><meta name="theme-color" content="{{ Studio::color(Studio::setting('design.primary'),'#0A3323') }}">
...
@if((\App\Support\Studio::setting('scripts.enabled',false)||\App\Support\Studio::setting('analytics.enabled',true))&&!config('studio.demo'))@include('site.partials.consent')@endif
